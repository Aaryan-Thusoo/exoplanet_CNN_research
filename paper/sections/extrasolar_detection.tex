...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.2\linewidth]{figures/images/exoplanet_method_numbers}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/other_papers/WASP-104b_transit.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/images/transit_anatomy.png}
