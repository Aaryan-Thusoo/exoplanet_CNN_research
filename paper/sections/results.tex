...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{History/loss_history.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{History/accuracy_history.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Images/Results/real_confusion_matrix}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Images/Histograms/confidence_correct_vs_incorrect.png}
